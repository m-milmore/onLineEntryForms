...
export const summaryCategories = [
  ...
  "Adulte(16+) Danse Individuelle| x 35 $can = | x 40 $can = |1|single",
  "Adulte(16+) Multi 3 danses| x 45 $can = | x 50 $can = |1|champ",
  "Adulte(16+) Bourse d'étude| x 65 $can = | x 70 $can = |1|schol",
  "Junior(15-) Danse Individuelle| x 15 $can = | x 20 $can = |0|single",
  "Junior(15-) Multi 3 danses| x 20 $can = | x 25 $can = |0|champ",
  "Junior(15-) Bourse d'étude| x 30 $can = | x 35 $can = |0|schol",
  "Démonstration en solo (Adulte & Junior)| x 50 $can = | x 55 $can = |1|solo",
  "summaryEmpty",
  "summarySide|AMATEUR|16",
  "Adulte(16+) Couple / chaque catégorie| x 35 $can = | x 40 $can = |1|amCpl",
  "Adulte(16+) Cabaret| x 35 $can = | x 40 $can = |1|cabaret",
  "Adulte(19+) Amateur Mixte Danse Individuelle| x 35 $can = | x 40 $can = |1|mix1D",
  "Adulte(19+) Amateur Mixte Multi 3 danses| x 45 $can = | x 50 $can = |1|mix3D",
  "Adulte(19+) Amateur Mixte Multi 5 danses| x 65 $can = | x 70 $can = |1|mix5D",
  "Adulte(19+) Amateur Solo / Chaque danse| x 10 $can = | x 15 $can = |1|solo1D",
  "Adulte(19+) Amateur Solo / Multi danses| x 20 $can = | x 25 $can = |1|soloMulti",
  "Juvénile & Junior Couple / chaque catégorie| x 20 $can = | x 25 $can = |0|amCpl",
  "Juvénile, Junior & Jeunesse Amateur Mixte Danse Individuelle| x 10 $can = | x 10 $can = |0|mix1D",
  "Juvénile, Junior & Jeunesse Amateur Mixte Multi| x 20 $can = | x 20 $can = |0|mixMulti",
  "Juvénile, Junior & Jeunesse Amateur Solo / Chaque danse| x 10 $can = | x 15 $can = |0|solo1DR",
  "Juvénile, Junior & Jeunesse Amateur Solo / Multi 3 danses| x 20 $can = | x 25 $can = |0|soloMulti",
  "Juvénile & Junior Amateur pré-compétitif / Couple| x 20 $can = | x 20 $can = |0|preComp1DCpl",
  "Juvénile & Junior Amateur pré-compétitif / Simple| x 10 $can = | x 10 $can = |0|preComp1DSolo",
  "Formation d'équipe| x 65 $can = | x 75 $can = |1|formation",
  "summaryEmpty",
  "summarySide|PRO|3",
  "Chaque catégorie| x 110 $can = | x 125 $can = |1|pro",
  "Exhibition| x 85 $can = | x 95 $can = |1|exhibition",
  "summaryEmpty",
  "summarySide|BILLETS|9",
  "billets|BILLETS VENDREDI%1ère RANGÉE TABLE| x 70 $can = | x 75 $can = |friday1",
  "billets|%2e RANGÉE| x 55 $can = | x 60 $can = |friday2",
  "billets|%Juvénile + Junior 15 & -| x 25 $can = | x 30 $can = |friday0",
  "billets|BILLETS SAMEDI%1ère RANGÉE| x 70 $can = | x 75 $can = |saturday1",
  "billets|%2e RANGÉE| x 55 $can = | x 60 $can = |saturday2",
  "billets|%Juvénile + Junior 15 & -| x 25 $can = | x 30 $can = |saturday0",
  "billets|BILLETS DIMANCHE%Adulte| x 25 $can = | x 30 $can = |sunday1",
  "billets|%Juvénile + Junior 15 & -| x 20 $can = | x 25 $can = |sunday0",
  "summaryEmpty",
];
