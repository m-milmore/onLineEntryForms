...
const FORMS_INIT = [
  ...
  },
  {
    ...
    formSubmittable: false,
    items: [
      { name: "single1", quantity: 0, type: "entry" },
      { name: "champ1", quantity: 0, type: "entry" },
      { name: "schol1", quantity: 0, type: "entry" },
      { name: "single0", quantity: 0, type: "entry" },
      { name: "champ0", quantity: 0, type: "entry" },
      { name: "schol0", quantity: 0, type: "entry" },
      { name: "solo1", quantity: 0, type: "entry" },
      { name: "friday1", quantity: 0, type: "ticket" },
      { name: "friday2", quantity: 0, type: "ticket" },
      { name: "friday0", quantity: 0, type: "ticket" },
      { name: "saturday1", quantity: 0, type: "ticket" },
      { name: "saturday2", quantity: 0, type: "ticket" },
      { name: "saturday0", quantity: 0, type: "ticket" },
      { name: "sunday1", quantity: 0, type: "ticket" },
      { name: "sunday0", quantity: 0, type: "ticket" },
    ],
  },
];
